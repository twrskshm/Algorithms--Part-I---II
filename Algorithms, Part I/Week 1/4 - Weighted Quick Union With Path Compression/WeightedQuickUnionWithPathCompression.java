/*
Java implementation of Weighted Quick Union with Path Compression, an improvement of Weighted Quick Union algorithm
...
public class WeightedQuickUnionWithPathCompression {
    ...
    public WeightedQuickUnionWithPathCompression(int array_length) {
    ...
    public int root(int node_index) {
        ...
        while(node_index != array[node_index]) {
            array[node_index] = array[array[node_index]];
